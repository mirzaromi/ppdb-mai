...
<head>
    ...
    <link rel="stylesheet" href="/assets/public/assets/css/post_register.css" />
    ...
    <div class="register bg-soft-primary">
        ...
        <div class="regis-panel">
            ...
            <div class="regis-form bg-pale-primary">
                <h1 class="regis-message">Selamat Anda telah mendaftar PPDB MAI Amanatul Ummah</h1>
                ...
                <div class="form-action">
                    <p>Silahkan klik tombol di bawah ini untuk melanjutkan ke halaman login</p>
                    <div class="d-grid">
