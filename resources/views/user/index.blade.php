...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/assets/user/flexy-bootstrap-lite/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="/assets/user/flexy-bootstrap-lite/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="/assets/user/flexy-bootstrap-lite/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="/assets/user/flexy-bootstrap-lite/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/assets/user/flexy-bootstrap-lite/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="/assets/user/flexy-bootstrap-lite/dist/js/app-style-switcher.js"></script>
    <!--Wave Effects -->
    <script src="/assets/user/flexy-bootstrap-lite/dist/js/waves.js"></script>
    <!--Menu sidebar -->
