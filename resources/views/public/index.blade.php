...
<body class="onepage" data-bs-spy="scroll" data-bs-target=".navbar">
                ...
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    <div class="navbar-brand w-100">
                        <a href="/assets/public/index.html">
                            <img src="/img/Logo MAI Lengkap Berwarna.png" srcset="/img/Logo MAI Lengkap Berwarna.png"
                                alt="" width="150px" />
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto" data-sm-skip="true">
                            ...
                            <li class="nav-item d-none d-md-block">
                                <a href="/assets/public/contact.html"
                                    class="btn btn-sm btn-primary rounded-pill">Masuk</a>
                            </li>
                ...
                <div class="container pt-10 pt-md-14 pb-14 pb-md-17 text-center">
                    ...
                    <div class="row text-center mt-10">
                        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                            <figure><img class="w-auto" src="/assets/public/assets/img/concept/concept8.png"
                                    srcset="/assets/public/assets/img/concept/concept8@2x.png 2x" alt="" /></figure>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
                ...
                <div class="container">
                    <div class="row  mb-1 pb-1">
                        <div class="col-lg-12 text-center">
                            <h1 class="text-uppercase fw-bold">Layanan</h1>
    ...
    <script src="/assets/public/assets/js/plugins.js"></script>
